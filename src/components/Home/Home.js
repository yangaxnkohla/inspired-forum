            ...
            <div className="row">
              ...
              <div id="myModal" className="col-1-3">
                <div className="card shadow-sm p-3 mb-2 bg-dark post-section" style={{ display: "flex", flexDirection: "row", boxShadow: "0 19px 38px rgba(0,0,0,0.30), 0 15px 12px rgba(0,0,0,0.22)" }}>
                  ...
                  <Form onSubmit={this.handlePost} action="home" method="POST" className="form-inline" style={{ width: "100%" }}>
                    <FormControl as="textarea" rows="2" type="text" maxLength="250" id="post" name="post" placeholder="Write a post..." className="card mr-sm-2" onChange={this.handleChange} style={{ resize: "none", borderRadius: "25px", width: "440px", border: "1px solid gainsboro" }} required autoFocus />
                    <Button id="postBtn" variant="primary" type="submit" style={{ height: "40px", backgroundColor: "rgb(32,32,32)" }}><b><i className="fa fa-paper-plane" style={{ color: "gold" }}></i> Post</b></Button>
                  </Form>
                </div>
